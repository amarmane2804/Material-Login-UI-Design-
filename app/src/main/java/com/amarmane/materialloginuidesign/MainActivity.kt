package com.amarmane.materialloginuidesign

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Patterns
import androidx.appcompat.app.AlertDialog
import com.amarmane.materialloginuidesign.databinding.ActivityMainBinding

class TestingLoginFeatures : AppCompatActivity() {
    ...
    private fun validEmail(): String? {
        val emailText = binding.passwordEditText.text.toString()
